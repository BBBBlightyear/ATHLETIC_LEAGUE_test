                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            ...
                            <li>
                                ...
                                <a href="${pageContext.request.contextPath}/showStudentByPage?currentPage=${pb.currentPage - 1}&rows=5&Student_Name=${condition.Student_Name[0]}&Major=${condition.Major[0]}&Strong_point=${condition.Stront_point[0]}&Student_ID=${condition.Student_ID[0]}" aria-label="Previous">
                            ...
                            <li>
                                ...
                                <a href="${pageContext.request.contextPath}/showStudentByPage?currentPage=${pb.currentPage + 1}&rows=5&Student_Name=${condition.Student_Name[0]}&Major=${condition.Major[0]}&Strong_point=${condition.Stront_point[0]}&Student_ID=${condition.Student_ID[0]}" aria-label="Next">
